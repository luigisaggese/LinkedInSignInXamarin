...
public unsafe partial class LISDKAPIError : NSError {
	...
	[CompilerGenerated]
	public static NSObject ErrorWithApiResponse (global::LISDKAPIResponse response)
	{
		if (response == null)
	...
	[CompilerGenerated]
	public virtual global::LISDKAPIResponse ErrorResponse {
		[Export ("errorResponse")]
		get {
			global::LISDKAPIResponse ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<global::LISDKAPIResponse> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("errorResponse")));
			} else {
				ret =  Runtime.GetNSObject<global::LISDKAPIResponse> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("errorResponse")));
			}
