...
public unsafe partial class LISDKAccessToken : NSObject {
	...
	[CompilerGenerated]
	public static global::LISDKAccessToken LISDKAccessTokenWithSerializedString (string serString)
	{
		if (serString == null)
			throw new ArgumentNullException ("serString");
		var nsserString = NSString.CreateNative (serString);
		
		global::LISDKAccessToken ret;
		ret =  Runtime.GetNSObject<global::LISDKAccessToken> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("LISDKAccessTokenWithSerializedString:"), nsserString));
	...
	[CompilerGenerated]
	public static global::LISDKAccessToken LISDKAccessTokenWithValue (string value, global::System.Int64 expiresOnMillis)
	{
		if (value == null)
		...
		global::LISDKAccessToken ret;
		ret =  Runtime.GetNSObject<global::LISDKAccessToken> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_Int64 (class_ptr, Selector.GetHandle ("LISDKAccessTokenWithValue:expiresOnMillis:"), nsvalue, expiresOnMillis));
