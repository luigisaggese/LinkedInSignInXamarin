...
namespace LinkedIn.SignIn {
	...
	public unsafe partial class LISDKSessionManager : NSObject {
		...
		[CompilerGenerated]
		public static void CreateSessionWithAccessToken (LISDKAccessToken accessToken)
		{
			if (accessToken == null)
		...
		[CompilerGenerated]
		public unsafe static void CreateSessionWithAuth (string[] permissions, string state, bool showDialog, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAuthSuccessBlock))]AuthSuccessBlock successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAuthErrorBlock))]AuthErrorBlock erroBlock)
		{
			if (permissions == null)
			...
			var nsa_permissions = NSArray.FromStrings (permissions);
		...
		[CompilerGenerated]
		public static LISDKSessionManager SharedInstance ()
		{
			return  Runtime.GetNSObject<LISDKSessionManager> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("sharedInstance")));
		}
		...
		[CompilerGenerated]
		public virtual LISDKSession Session {
			[Export ("session")]
			get {
				LISDKSession ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<LISDKSession> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("session")));
				} else {
					ret =  Runtime.GetNSObject<LISDKSession> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("session")));
				}
