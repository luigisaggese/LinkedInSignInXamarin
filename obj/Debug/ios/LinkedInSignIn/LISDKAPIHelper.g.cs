...
namespace LinkedIn.SignIn {
	...
	public unsafe partial class LISDKAPIHelper : NSObject {
		...
		[CompilerGenerated]
		public unsafe virtual void ApiRequest (string url, string method, NSData body, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
		...
		[CompilerGenerated]
		public unsafe virtual void DeleteRequest (string url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (successCompletion == null)
		...
		[CompilerGenerated]
		public unsafe virtual void GetRequest (string url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> success, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> error)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (success == null)
		...
		[CompilerGenerated]
		public unsafe virtual void PostRequest (string url, NSData body, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (body == null)
		...
		[CompilerGenerated]
		public unsafe virtual void PostRequest (string url, string stringBody, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (stringBody == null)
		...
		[CompilerGenerated]
		public unsafe virtual void PutRequest (string url, NSData body, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (body == null)
		...
		[CompilerGenerated]
		public unsafe virtual void PutRequest (string url, string stringBody, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<LISDKAPIResponse> successCompletion, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V1))]global::System.Action<LISDKAPIError> errorCompletion)
		{
			if (url == null)
				throw new ArgumentNullException ("url");
			if (stringBody == null)
		...
		[CompilerGenerated]
		public static LISDKAPIHelper SharedInstance ()
		{
			return  Runtime.GetNSObject<LISDKAPIHelper> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("sharedInstance")));
		}
