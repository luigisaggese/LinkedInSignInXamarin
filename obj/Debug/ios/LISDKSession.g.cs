...
public unsafe partial class LISDKSession : NSObject {
	...
	[CompilerGenerated]
	public virtual global::LISDKAccessToken AccessToken {
		[Export ("accessToken", ArgumentSemantic.Retain)]
		get {
			global::LISDKAccessToken ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<global::LISDKAccessToken> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("accessToken")));
			} else {
				ret =  Runtime.GetNSObject<global::LISDKAccessToken> (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("accessToken")));
			}
